...
{
    class ManifestNameFieldValidationExceptionable : BaseValidation
    {
        ...
        public ManifestNameFieldValidationExceptionable()
        {
        ...
        void CheckNameField(string manifestName)
        {
            ...
            // Unity will try to things to packages ending in these extensions that may be undesired
